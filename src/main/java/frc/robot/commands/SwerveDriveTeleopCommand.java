...
public class SwerveDriveTeleopCommand extends Command {
  ...
  private final SubsystemSwerveDrivetrain swerveDrivetrain;
  private final CommandXboxController controller;
  /** Creates a new SwerveDriveTeleopCommand. */
  public SwerveDriveTeleopCommand(SubsystemSwerveDrivetrain swerveDrivetrain, CommandXboxController controller) {
  ...
  public void execute() {
    ...
    swerveDrivetrain.drive(xSpeed*2, ySpeed*2, angularSpeed * 4,false);
  }
